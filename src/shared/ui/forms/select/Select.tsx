...
import { Icon28ChevronDownOutline, Icon28DoneOutline } from '@vkontakte/icons'

import { FieldSurface } from '../field-surface'
import { fieldSurfaceVariants } from '../field-surface/field-surface.variants'
							...
							>
								<div
									...
									className={twMerge(
										...
										'max-h-40 overflow-y-auto flex flex-col p-1.5 gap-0.5',
