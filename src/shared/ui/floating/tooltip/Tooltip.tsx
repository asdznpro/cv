...
import { tooltipArrowFill, tooltipVariants, resolveTooltipPlacement } from './tooltip.variants'
...
export function Tooltip(props: TooltipProps) {
	...
	const {
		...
		placement: resolveTooltipPlacement(placement, align),
		open: isOpen,
